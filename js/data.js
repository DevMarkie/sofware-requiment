...
export const sampleData = {
  ...
  modules: [
    { id: 'm-cloud-lt', code: 'CLOUD-LT', name: 'Lý thuyết Điện toán đám mây', credits: 2, courseId: 'c-cloud' },
    { id: 'm-cloud-th', code: 'CLOUD-TH', name: 'Thực hành Điện toán đám mây', credits: 1, courseId: 'c-cloud' },
    { id: 'm-hci-lt', code: 'HCI-LT', name: 'Lý thuyết HCI', credits: 2, courseId: 'c-hci' },
    { id: 'm-db-lt', code: 'DB-LT', name: 'Lý thuyết CSDL', credits: 3, courseId: 'c-db' },
    { id: 'm-ml-lt', code: 'ML-LT', name: 'Lý thuyết Máy học', credits: 3, courseId: 'c-ml' },
    { id: 'm-ml-th', code: 'ML-TH', name: 'Thực hành Máy học', credits: 1, courseId: 'c-ml' },
    { id: 'm-ds-lt', code: 'DS-LT', name: 'Lý thuyết Khai phá DL', credits: 3, courseId: 'c-ds' },
    { id: 'm-mkt-cb-lt', code: 'MKT-LT', name: 'Lý thuyết Marketing CB', credits: 2, courseId: 'c-mkt-cb' },
    { id: 'm-tc-co-ban-lt', code: 'FIN-LT', name: 'Lý thuyết Tài chính CB', credits: 2, courseId: 'c-tc-co-ban' },
    { id: 'm-dtdc-mt', code: 'DTDC-LT', name: 'Mạch tương tự LT', credits: 2, courseId: 'c-dtdc-1' },
    { id: 'm-cokhi-nlm', code: 'CK-NLM', name: 'Nguyên lý máy LT', credits: 2, courseId: 'c-cokhi-1' }
  ]
};
